...
import com.termux2.shared.net.uri.UriUtils;
import com.termux2.shared.errors.Errno;
import com.termux2.shared.shell.ShellUtils;
...
import com.termux2.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.termux2.shared.termux.shell.TermuxShellUtils;
...
import com.termux2.shared.termux.shell.TermuxShellManager;
...
import com.termux2.shared.shell.command.ExecutionCommand.ShellCreateMode;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.termux2.shared.R.string.error_execution_cancelled))) {
